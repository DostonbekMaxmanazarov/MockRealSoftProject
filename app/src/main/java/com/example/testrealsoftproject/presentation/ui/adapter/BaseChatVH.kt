...
sealed class BaseChatVH(itemView: View) : RecyclerView.ViewHolder(itemView) {

    class LeftPhotoVH(private val binding: ItemImageLeftBinding) : BaseChatVH(binding.root) {
    ...
    class LeftFileVH(private val binding: ItemFileLeftBinding) : BaseChatVH(binding.root) {
    ...
    class LeftMessageVH(private val binding: ItemMessageLeftBinding) : BaseChatVH(binding.root) {
        fun bind(messageData: BaseChatData.LeftMessageData) {
            binding.tvMessageLeft.setText(R.string.message)
        }
    }

    class RightMessageVH(private val binding: ItemMessageRightBinding) : BaseChatVH(binding.root) {
    ...
    class DayVH(private val binding: ItemDayBinding) : BaseChatVH(binding.root) {
